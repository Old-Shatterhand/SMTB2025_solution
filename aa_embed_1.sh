...
# for model in progen2_small progen2_medium progen2_large; do
#     for dataset in deeploc2 meltome_atlas fluorescence scope_40_208 stability; do
#         python -m src.plm --model-name $model --data-path $BASE/datasets/$dataset.csv --output-path $BASE/embeddings/$model/$dataset
#     done
